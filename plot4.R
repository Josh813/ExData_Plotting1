...
data <- select(data, Day, Global_active_power, Global_reactive_power, 
...
with(data, plot(Day, Voltage, type = "l", xlab="datetime", 
                ylab="Voltage"))

#fourth chart

with(data, plot(Day, Global_reactive_power, type = "l", xlab="datetime", 
